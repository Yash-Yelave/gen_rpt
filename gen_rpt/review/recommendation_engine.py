...
def generate_recommendations_text(client: 'GroqClient', text: str, dimensions: Dict[str, Any]) -> Dict[str, Any]:
    system = "You are a Senior Strategy Consultant. Return strict JSON only."
    user = f"""
Based on the following AI Review dimension scores and the report text, generate a strength/weakness analysis, improvement recommendations, and an executive readiness assessment.
